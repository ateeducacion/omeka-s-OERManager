...
- **Pendiente a continuación:** **4b IA-assist** (TASK-010, requiere `composer require smalot/pdfparser`); TASK-006 (estadísticas); TASK-007 (auditoría + reversibilidad real, ya **desbloqueada**).
