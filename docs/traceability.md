...
| Garantizar integridad del catálogo | RF-006 | ADR-0004 (campos a validar) | TASK-005 | Campos fijados; «completo» = obligatorios de la plantilla REA si existe, sino mínimo (alineamiento + licencia) |
