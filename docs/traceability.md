...
| Acelerar la catalogación con IA (propone, el curador confirma) | RF-009 | ADR-0007 (IA propone/curador confirma; label→búsqueda incremental) + ADR-0004 (mapeo) + ADR-0006 (raíces) | TASK-010 | La IA propone etiquetas por dimensión desde metadatos + contenido de medios; se resuelven a items-término sin volcar el árbol (NFR-004); el curador confirma y la escritura reusa el flujo de RF-004/RF-005 |
